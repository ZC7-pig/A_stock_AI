...
class SystemConfigFieldSchema(BaseModel):
    ...
    category: Literal["base", "analysis", "data_source", "ai_model", "notification", "system", "agent", "uncategorized"]
...
class TestDataSourceConnectionRequest(BaseModel):
    """Request payload for testing one data-source credential or endpoint."""
...
class TestDataSourceConnectionResponse(BaseModel):
