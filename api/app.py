...
def _check_frontend_assets_consistency(static_dir: Path) -> List[str]:
    ...
    is visible in the server logs instead of surfacing as a silent blank page.
    """
    ...
    if missing:
        logger.error(
            ...
            "blank page in the Web UI (see GitHub #1064 / #1065). "
...
def create_app(static_dir: Optional[Path] = None) -> FastAPI:
    ...
    if has_frontend:
        ...
        # server logs instead of via browser devtools.
