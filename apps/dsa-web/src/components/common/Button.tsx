...
const BUTTON_VARIANT_STYLES = {
  primary: 'border border-[color:var(--console-accent)] bg-primary-gradient text-primary-foreground shadow-sm hover:brightness-105',
  ...
  gradient: 'border border-[color:var(--console-accent)] bg-primary-gradient text-primary-foreground shadow-sm hover:brightness-105',
