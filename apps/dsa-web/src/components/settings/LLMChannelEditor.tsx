...
export const LLMChannelEditor: React.FC<LLMChannelEditorProps> = ({
  ...
  const handleSave = async () => {
    ...
    const runtimeConfigForSave = sanitizeRuntimeConfigForSave(runtimeConfig, availableModels);
    ...
    try {
      const updateItems = channelsToUpdateItems(channels, initialNames, runtimeConfigForSave, true);
