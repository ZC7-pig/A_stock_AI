...
class TestStorage(unittest.TestCase):
    ...
    def test_get_chat_sessions_prefix_is_scoped_by_colon_boundary(self):
        ...
        db.save_conversation_message("web_user_12345:chat", "user", "first user")
        db.save_conversation_message("web_user_123456:chat", "user", "second user")

        sessions = db.get_chat_sessions(session_prefix="web_user_12345")

        self.assertEqual(len(sessions), 1)
        self.assertEqual(sessions[0]["session_id"], "web_user_12345:chat")
