...
class SystemConfigApiTestCase(unittest.TestCase):
    ...
    def test_get_config_returns_raw_secret_value(self) -> None:
        ...
        self.assertNotIn("GEMINI_API_KEY", item_map)
        self.assertEqual(item_map["LLM_CHANNELS"]["value"], "gemini")
        self.assertEqual(item_map["LLM_GEMINI_API_KEY"]["value"], "secret-key-value")
        self.assertFalse(item_map["LLM_GEMINI_API_KEY"]["is_masked"])
    ...
    def test_put_config_updates_secret_and_plain_field(self) -> None:
        ...
        payload = system_config.update_system_config(
            request=UpdateSystemConfigRequest(
                ...
                items=[
                    ...
                    {"key": "LLM_GEMINI_API_KEY", "value": "new-secret-value"},
        ...
        self.assertEqual(payload["applied_count"], 5)
        ...
        self.assertIn("LLM_GEMINI_API_KEY=new-secret-value", env_content)
        self.assertIn("LLM_GEMINI_MODELS=gemini-2.5-flash", env_content)
    ...
    def test_test_data_source_connection_endpoint_returns_service_payload(self) -> None:
        with patch.object(
            self.service,
            ...
            return_value={
                ...
                "error": None,
                "code": "ok",
                "tested_key": "TAVILY_API_KEYS",
                "provider": "Tavily",
                "latency_ms": 88,
            },
        ) as mock_test:
            payload = system_config.test_data_source_connection(
