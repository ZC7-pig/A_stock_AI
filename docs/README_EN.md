...
Analyze your watchlist daily, combine multiple data sources, and generate interactive research reports in the Web workspace.

[**Key Features**](#-key-features) · [**Quick Start**](#-quick-start) · [**Sample Report**](#-sample-report) · [**Full Guide**](./full-guide_EN.md) · [**FAQ**](./FAQ_EN.md) · [**Changelog**](./CHANGELOG.md)
...
| Web | Dual-theme Workspace | Manual analysis, settings, task progress, history, and smart import |
...
| Agent Q&A | Strategy Chat | Multi-turn strategy chat with 11 built-in strategies across Web/API |
...
Full environment variables, model routing, data-source priority, trading rules, fundamental P0 semantics, and deployment details are in the [Full Guide](./full-guide_EN.md).

## 🖥️ Web UI

![FastAPI Web UI](../sources/fastapi_server.png)

The Web workspace supports settings, task monitoring, manual analysis, history reports, smart import, and light/dark themes.
...
- Supports follow-up questions, session export, and background execution
