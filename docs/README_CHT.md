...
每日自動分析自選股，聚合多數據源，並在 Web 工作台生成可交互研究報告。

[**功能特性**](#-功能特性) · [**快速開始**](#-快速開始) · [**報告示例**](#-報告示例) · [**完整指南**](./full-guide.md) · [**常見問題**](./FAQ.md) · [**更新日誌**](./CHANGELOG.md)
...
完整環境變數、模型渠道、數據源優先級、交易紀律、基本面 P0 語義和部署說明請參考 [完整配置指南](./full-guide.md)。

## 🖥️ Web 介面

![FastAPI Web UI](../sources/fastapi_server.png)

Web 工作台提供配置管理、任務監控、手動分析、歷史報告、智能匯入和淺色 / 深色主題。啟動方式：
